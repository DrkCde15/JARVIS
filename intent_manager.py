...
class IntentManager:
    ...
    def classify_intent(self, text):
        ...
        prompt = (
            ...
            "User: 'toca o som do alok' -> {\"intent\": \"play_music\", \"param\": \"alok\"}\n"
            "User: 'o que eu tenho pra hoje?' -> {\"intent\": \"show_agenda\", \"param\": \"\"}\n"
            "User: 'que horas são?' -> {\"intent\": \"check_time\", \"param\": \"\"}\n\n"
            "### RULES ###\n"
            "1. Verbos 'ver', 'olhar', 'visitar', 'abrir' + site/rede social => open_site.\n"
            "2. Palavras 'agenda', 'tarefa', 'compromisso', 'hoje' => show_agenda.\n"
            "3. Se for apenas conversa ou saudação => chat.\n\n"
